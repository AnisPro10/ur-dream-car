...
export const TERMES: Terme[] = [
  // Finance
  { mot: "Chiffre d'affaires (CA)", cat: "Finance", def: "Tout l'argent encaissé par les ventes, avant de retirer la moindre dépense.", exemple: "24 voitures vendues ~3 280 € en moyenne → CA ≈ 78 720 €." },
  { mot: "Marge brute", cat: "Finance", def: "Prix de revente moins prix d'achat du véhicule. C'est ce qui reste avant les frais.", exemple: "Achetée 2 500 €, revendue 3 200 € → marge brute 700 €." },
  { mot: "Frais variables", cat: "Finance", def: "Dépenses liées à chaque voiture : préparation, transport, garantie, contrôle technique, annonces. Plus on vend, plus ils montent.", exemple: "≈ 335 € par voiture dans le paramétrage actuel (dont 100 € de provision garantie)." },
  { mot: "Contribution", cat: "Finance", def: "Ce qu'une voiture rapporte vraiment : marge brute − TVA sur marge − frais variables. Si c'est négatif, chaque vente fait perdre de l'argent.", exemple: "Paramétrage actuel : entrée de gamme ≈ +248 € ; 2ᵉ segment ≈ +498 €. (Étude initiale : −102 € / +315 €.)" },
  { mot: "Charges fixes", cat: "Finance", def: "Dépenses qui tombent tous les mois même sans vendre : local, assurances, abonnements.", exemple: "400 €/mois = 4 800 €/an à couvrir avant de gagner 1 € (dont 250 € d'assurance)." },
  { mot: "Seuil de rentabilité", cat: "Finance", def: "Nombre de ventes nécessaire pour couvrir les charges fixes. En dessous on perd, au-dessus on gagne.", exemple: "≈ 18 voitures/an avec le paramétrage actuel (l'étude initiale donnait 257 — marge unitaire trop faible)." },
  { mot: "Résultat net", cat: "Finance", def: "Le vrai bénéfice (ou la vraie perte) de l'année, une fois TOUT payé : achats, frais, salaires, impôts.", exemple: "Paramétrage actuel : ≈ +1 496 € ; scénario réaliste (toutes charges) : ≈ −24 810 €." },
  ...
  { mot: "BFR", cat: "Finance", def: "Besoin en fonds de roulement : l'argent immobilisé dans le stock en attendant de revendre. Il faut le financer avec le capital ou des aides.", exemple: "Paramétrage actuel : ≈ 11 140 € immobilisés (stock + frais engagés), couverts par 20 000 € de capital." },
  ...
  { mot: "Dividendes SARL > 10 % du capital", cat: "Fiscalité", def: "En SARL, la part des dividendes du gérant majoritaire au-delà de 10 % du capital paie ~45 % de cotisations TNS + 12,8 % d'impôt (≈ 57,8 %), au lieu de la flat tax.", exemple: "Capital 20 000 € → seuil 2 000 € : au-delà, ≈ 57,8 % de prélèvements." },
  ...
  { mot: "Capital social", cat: "Juridique", def: "L'argent apporté par les associés à la création. Finance le démarrage et sert de référence au seuil des 10 % pour les dividendes SARL.", exemple: "Projet : 20 000 € (apports + ARCE)." },
  { mot: "Garantie légale de conformité", cat: "Juridique", def: "Obligation du vendeur professionnel : 2 ans de garantie. Pendant 12 mois (occasion), le défaut est présumé exister depuis la vente — au vendeur de prouver le contraire.", exemple: "Provision : choix de gestion — 100 € (pari d'un très bon tri) à 700 € (prudence haute). Une panne lourde coûte 800-2 500 €." },
  // Aides & social
  ...
  // Métier auto
  { mot: "Crit'Air 2", cat: "Métier auto", def: "Vignette des diesels récents et essence 2006-2010. Encore autorisée dans la ZFE du Grand Paris — segment le plus rentable du projet (≈ +498 €/voiture au paramétrage actuel).", },
  ...
  { mot: "Courtage", cat: "Métier auto", def: "Vendre sans acheter : on trouve la voiture pour le client et on facture une commission. Pas de stock, pas de BFR, pas de garantie portée — la voie de démarrage recommandée.", exemple: "600 € de commission par mandat ; rentable dès la 1re année (≈ +2 346 €), sans stock ni BFR." },
